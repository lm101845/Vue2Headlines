...
> 链接：https://www.yuque.com/lipengzhou/toutiao-mobile-vue/catt08
...
设计师为我们单独提供了设计稿中的图标，为了方便使用，我们在这里把它制作为**字体图标**。——因为svg图标的兼容性不太好。
...
| /user/chat          | views/my-profile/index.vue | 小智同学           |
...
> 一个经验：使用组件库中的现有组件快速布局，再慢慢调整细节，效率更高（刚开始可能会感觉有点麻烦，越用越熟）。
